...
DEFAULT_BACKEND_URL = "http://127.0.0.1:8000/agent/rhenan-agent/chat"


STATE_KEY = "agente_rhenan_messages"


st.set_page_config(
    page_title="Carlinhos",
...
st.title("Bibliotecário Carlinhos")
st.caption("Boa sorte se precisar de um livro.")

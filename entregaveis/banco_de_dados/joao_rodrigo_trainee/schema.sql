...
CREATE TABLE estados (
    ...
    id_regiao INTEGER REFERENCES regioes(id_regiao) NOT NULL
);

CREATE TABLE municipios (
    id_municipio INTEGER PRIMARY KEY,
    nome_municipio TEXT NOT NULL,
    id_uf INTEGER REFERENCES estados(id_uf)
);

CREATE TABLE populacao_municipal (
    id_municipio INTEGER REFERENCES municipios(id_municipio) NOT NULL,

-- schema.sql
-- Modelo relacional normalizado (3FN) a partir das tabelas brutas raw_.
-- Hierarquia geografica: regioes -> estados -> municipios, com uma tabela
-- de fatos (populacao_municipal) referenciando municipios.

...
from app.schemas import (
    LPMunicipio as Municipio,
    LPEstado as Estado,
    Regiao,
    LPResumoEstatistico as ResumoEstatistico,
    LPMunicipioPopulacao as MunicipioPopulacao,
    LPPopulacaoPorRegiao as PopulacaoPorRegiao,
    LPPopulacaoPorEstado as PopulacaoPorEstado,
    LPDispersaoEstado as DispersaoEstado,
    LPHeatmapRegiaoPorte as HeatmapRegiaoPorte,
    LPMunicipioCreate as MunicipioCreate,
    LPMunicipioUpdate as MunicipioUpdate,
    LPMunicipioComPopulacao as MunicipioComPopulacao,
    LPRegistroGestorCreate as RegistroGestorCreate,
    LPRegistroGestorUpdate as RegistroGestorUpdate,
    LPRegistroGestor as RegistroGestor,
)
